declare namespace API {
  type addQuestionFavourCountUsingPOSTParams = {
    /** questionId */
    questionId: number;
  };

  type addQuestionLikeCountUsingPOSTParams = {
    /** questionId */
    questionId: number;
  };
  ...
  type deleteQuestionFavourCountUsingDELETEParams = {
    /** questionId */
    questionId: number;
  };

  type deleteQuestionLikeCountUsingDELETEParams = {
    /** questionId */
    questionId: number;
  };
