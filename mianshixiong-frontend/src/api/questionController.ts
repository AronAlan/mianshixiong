...
/** getRecommendQuestionVoById GET /api/question/get/recommend */
export async function getRecommendQuestionVoByIdUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseListRecommendQuestionVo_>('/api/question/get/recommend', {
    method: 'GET',
    ...(options || {}),
  });
}
